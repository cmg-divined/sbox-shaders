...
public void RenderEffect(SceneCamera camera)
{
    ...
    attributes.Set("Kuwahara._BlurStrength", 20); // Increase blur strength

    Graphics.GrabFrameTexture("ColorBuffer", attributes);
    Graphics.GrabDepthTexture("DepthBuffer", attributes);
    Graphics.Blit(Material.Load("materials/postprocess/postprocess_toon_shader.vmat"), attributes);
}
